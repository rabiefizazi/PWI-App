...
public class MainActivity extends Activity implements EMDKListener, DataListener, StatusListener, ScannerConnectionListener, OnCheckedChangeListener {
    ...
    private CheckBox checkBoxMSI = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBoxMSI = (CheckBox) findViewById(R.id.checkBoxMSI);
        ...
        checkBoxMSI.setOnCheckedChangeListener(this);
    ...
    private class AsyncDataUpdate extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                ...
                /*Intent intent=new Intent(MainActivity.this, QuantityDialog.class);
                ...
                final EditText etQuantity = (EditText) quantityDialog.findViewById(R.id.etQantity);
    ...
    private class AsyncUiControlUpdate extends AsyncTask<Boolean, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean bEnable) {
            ...
            checkBoxMSI.setEnabled(bEnable);
